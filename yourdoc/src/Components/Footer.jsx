...
return (
    <Stack>
    <HStack bg="#666666" color='#fff' textAlign='left' alignItems="flex-start" fontWeight={100} marginBottom={-2} >
<Box  m='10px' p='10px'  >
...
<Flex flex='1'display='flex' bg='#505050' color='#fff' mt='0px' padding='10px'>
    <Text>We accept</Text>
    <Image src='https://1000logos.net/wp-content/uploads/2017/03/MasterCard-Logo-1990.png' w={10} />
    <Image src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT031oEu5_UkIHW7hrpQruynx00PcnA0wTR_g&usqp=CAU' w={10} />
    <Image src='https://1000logos.net/wp-content/uploads/2017/03/MasterCard-Logo-1990.png' w={10} />
    <Image src='https://1000logos.net/wp-content/uploads/2017/03/MasterCard-Logo-1990.png' w={10} />
</Flex>
</Stack>
